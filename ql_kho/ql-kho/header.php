...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-light bg-primary">
        <a class="navbar-brand ps-3" href="index.php">Cửa hàng Minh Phương</a>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-primary bg-light"  id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link collapsed" href="phieunhaphang.php">
                        ...
                        <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="thongke_soluong_nhap.php">Thống kê số lượng nhập</a>
                                    <a class="nav-link" href="thongke_soluong_xuat.php">Thống kê số lượng xuất</a>
